...
real, dimension(L**2) :: p_infinite_n ! probability that a site belongs to the percolating cluster (order parameter) as function of n=number of occupied sites
